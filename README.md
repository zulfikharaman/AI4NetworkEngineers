...
| [Log Analysis using AI](use-cases/basic/log-analysis.md) | Intermittent packet loss with noisy syslogs | Sample syslog messages | [Analyze logs, identify patterns, and suggest safe verification steps](prompts/basic/log-analysis-prompt.ms) |
| [Config Review with AI](use-cases/basic/) | Pre-change review of routing and ACL configuration | Router configuration snippet | [Review configuration for risks and validation points - no changes](prompts/basic/) |
``
